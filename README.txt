...
De asemenea, stiva se inchide si "elementul"
este stocat in stiva cu un nivel mai jos.
...
--- fiecare operatia are functia  sa (STAR,CONCAT,
PLUS,UNION) care primeste un numar specific
...
input (cuvantul) care va fi scanat
Returneaza un fisier care contine un sir de 
tokens si lexeme identificate.
